...
void main(List<String> arguments) {
  ...
  /*
  final Derek = Person("Derek", "Snow");
  final anni = Student("anni", "Snow");
  final acid = SchoolBandMember('acid', 'Derek');
  final mummy = StudentAthlete('mummy', 'McFly');
  print(Derek.fullName);
  print(anni.fullName);
  final historyGrade = Grade.B;
  anni.grades.add(historyGrade);
  final students = [anni, acid, mummy];
